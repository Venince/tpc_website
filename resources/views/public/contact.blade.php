                ...
                <aside class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div class="px-5 py-4 border-b border-gray-100">
                            <p class="text-xs font-bold text-tpc-primary uppercase tracking-widest">Contact Information</p>
                        </div>
                        <div class="divide-y divide-gray-100">
                            <div class="flex items-start gap-4 p-5">
                                <span class="shrink-0 flex h-9 w-9 items-center justify-center rounded-xl bg-tpc-primary/10 text-tpc-primary">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <div class="h-1.5 bg-tpc-primary"></div>
                        <div class="px-5 py-4 border-b border-gray-100">
                            <p class="text-xs font-bold text-tpc-primary uppercase tracking-widest">Campus Map</p>
                        </div>
                        <div class="p-5">
                            ...
                            @else
                                <div class="h-48 rounded-xl border border-dashed border-gray-300 flex items-center justify-center text-sm text-gray-400">
