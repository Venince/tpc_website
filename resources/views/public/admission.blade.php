...
@section('content')
    ...
    (function () {
        ...
        styleEl.textContent = [
            ...
            '@media(max-width:639px){#dl-fab{padding:.75rem;border-radius:50%;bottom:1.25rem;left:1.25rem;}.dl-fab-label{display:none;}}',
