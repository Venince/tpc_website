            ...
            <div class="grid gap-8 lg:grid-cols-3 lg:items-start">
                ...
                <div class="lg:col-span-2 space-y-6 min-w-0">
                    ...
                    @if ($service->featured_image_path)
                        <div class="rounded-3xl overflow-hidden border border-gray-100 shadow-md w-full">
                    ...
                    @if ($service->contents->isNotEmpty())
                        @foreach ($service->contents as $block)
                            ...
                            @if ($block->isText())
                                <div class="bg-white rounded-3xl border border-gray-100 shadow-md p-6 sm:p-8">
                                    @if ($block->heading)
                            ...
                            @elseif ($block->isImage() && $block->image_path)
                                <figure class="rounded-3xl overflow-hidden border border-gray-100 shadow-md">
                                    @if ($block->heading)
