        ...
        <div class="max-w-7xl mx-auto px-4 py-8 sm:py-10">
            ...
            <div class="flex items-start gap-3 sm:gap-5">
                ...
                <div class="min-w-0">
                    <div class="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                        <span class="inline-block bg-white/20 text-white text-[10px] sm:text-[11px] font-bold uppercase tracking-wider px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full backdrop-blur-sm">
                            {{ $program->code }}
                        </span>
                        @if ($program->department)
                            <span class="inline-block bg-tpc-accent/30 text-white text-[10px] sm:text-[11px] font-bold uppercase tracking-wider px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                                {{ $program->department }}
                            </span>
                        @endif
                    </div>
                    <h1 class="text-xl sm:text-4xl font-bold text-white leading-tight">{{ $program->name }}</h1>
                    @if ($program->description)
                        <p class="mt-1.5 sm:mt-2 max-w-2xl text-xs sm:text-sm text-white/75 leading-relaxed line-clamp-3 sm:line-clamp-none">{{ $program->description }}</p>
                    @endif
                </div>
            </div>
            ...
            <div class="mt-4 sm:mt-6 flex flex-wrap gap-2 sm:gap-3">
                <a href="{{ route('admission') }}"
                   class="inline-flex items-center justify-center gap-1.5 sm:gap-2 rounded-full border-2 border-white bg-white px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-bold text-tpc-primary
                ...
                <a href="{{ route('contact') }}"
                   class="inline-flex items-center justify-center rounded-full border-2 border-white/90 bg-black/20 backdrop-blur-sm px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-bold text-white
                          hover:bg-white/15 hover:border-white transition">
                    Ask a Question
                </a>
            </div>
        </div>
