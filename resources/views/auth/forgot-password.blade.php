<x-guest-layout>
    ...
    <div class="mb-6 border-b border-black/[0.06] pb-5">
        <div class="flex items-center gap-3 mb-1">
            <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-neo-bg shadow-neo-inset-sm">
            ...
            <h1 class="text-xl font-semibold text-neo-ink">Reset password</h1>
        </div>
        <p class="mt-1 text-sm text-neo-ink/55 leading-relaxed">
