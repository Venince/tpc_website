                    ...
                    <ul class="w-full space-y-3 text-sm text-white/75">
                        ...
                        <li>
                            ...
                            class="flex items-center gap-3 py-1 text-tpc-accent hover:text-white transition font-medium touch-manipulation">
                                <svg class="shrink-0 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="mailto:{{ $email }}"
                            class="flex items-center gap-3 py-1 text-tpc-accent hover:text-white transition font-medium touch-manipulation">
                                <svg class="shrink-0 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <li class="flex items-center gap-3 py-1">
                            <svg class="shrink-0 h-4 w-4 text-tpc-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <li class="flex items-start gap-3 py-1">
                            <svg class="shrink-0 h-4 w-4 text-tpc-accent mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
