...
<footer id="tpc-footer">
    ...
    <div class="bg-tpc-secondary text-white">
        <div class="max-w-7xl mx-auto px-5 py-10 sm:py-12">
            <div class="flex flex-col items-center gap-10 sm:flex-row sm:items-start sm:justify-between sm:gap-10">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="!text-left text-lg font-bold text-white leading-tight">{{ $siteName }}</p>
                        <p class="!text-left mt-1.5 text-sm text-white/70 leading-relaxed max-w-sm">
                ...
                <div class="flex flex-col items-center sm:items-start">
                    ...
                    <ul class="grid grid-cols-1 gap-y-4 sm:grid-cols-[max-content_max-content] sm:gap-x-10 text-sm text-white/75">

                        <li class="flex items-center gap-3">
                            <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/10 text-white">
                                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                                </svg>
                            </span>
                            <a href="https://www.facebook.com/TalibonPolytechnicCollege" target="_blank" rel="noopener noreferrer"
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="mailto:{{ $email }}" class="hover:text-white transition font-medium break-all">{{ $email }}</a>
                        </li>
