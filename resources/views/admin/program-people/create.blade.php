...
@section('content')
    ...
    <div class="max-w-lg">
        <form method="POST"
            ...
            {{-- Photo --}}
            <div>
                <label class="block text-sm font-medium text-neo-ink/70 mb-2">
                    Photo <span class="text-neo-ink/35 font-normal">(optional)</span>
                </label>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1.5 text-xs text-neo-ink/35">PNG / JPG / WEBP · max 5 MB · will be cropped to square</p>
                    </div>
                </div>
