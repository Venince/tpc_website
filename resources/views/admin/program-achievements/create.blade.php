...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
            ...
            <h1 class="text-lg font-semibold text-neo-ink">Add Achievement</h1>
            <p class="text-xs text-neo-ink/45 mt-0.5">Adding to: <span class="font-semibold text-neo-ink/70">{{ $program->name }}</span></p>
        </div>
    </div>
        ...
        <form method="POST"
            ...
            <div>
                <label for="photos-input" class="block text-sm font-medium text-neo-ink/70 mb-1.5">
                    Photos <span class="text-neo-ink/35 font-normal">(optional · up to 10)</span>
                </label>
                ...
                <div id="drop-zone"
                    ...
                    <p class="text-xs text-neo-ink/35">PNG / JPG / WEBP · max 5 MB each · up to 10 images</p>
