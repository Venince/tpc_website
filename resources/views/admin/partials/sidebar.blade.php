@php
    ...
    // Nav item base classes (neomorphic: idle is flat/quiet, active is pressed into the surface)
    $itemBase   = "group relative flex items-center rounded-2xl py-2.5 text-sm transition-all duration-200 ease-out active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-tpc-primary/20";
    $itemIdle   = "text-neo-ink/80 hover:text-neo-ink hover:shadow-neo-sm";
    $itemActive = "bg-neo-bg shadow-neo-inset-sm text-tpc-primary font-semibold";
    ...
    $iconBase   = "relative shrink-0 grid h-9 w-9 place-items-center rounded-xl transition-transform duration-200 group-hover:scale-105 group-active:scale-95";
    $iconIdle   = "bg-neo-surface shadow-neo-sm text-neo-ink/55 group-hover:text-tpc-primary";
    $iconActive = "bg-neo-surface shadow-neo-sm text-tpc-primary";
@endphp

<aside
    x-cloak
    class="fixed inset-y-0 left-0 z-50 w-72 bg-neo-surface shadow-neo-edge
       flex flex-col
...
>
    {{-- ── Brand ──────────────────────────────────────────────────────── --}}
   <div class="relative px-5 py-4 flex-shrink-0"
        ...
        <button
            ...
            class="absolute right-3 top-3 sm:hidden inline-flex h-9 w-9 items-center justify-center rounded-xl
                   bg-neo-surface text-neo-ink/60 shadow-neo-sm
                   hover:text-tpc-primary hover:shadow-neo-hover active:shadow-neo-inset-sm transition"
        ...
        >
            {{-- Logo pill --}}
            <div class="relative h-11 w-11 shrink-0 rounded-2xl bg-neo-surface shadow-neo-sm
            ...
            >
                <p class="text-sm font-semibold text-neo-ink leading-tight transition">
                    TPC Admin
                </p>
                <p class="text-xs text-neo-ink/45 truncate">Manage website content</p>
            </div>
        </a>
    </div>

    {{-- Divider under brand --}}
    <div class="px-5" :class="sidebarCollapsed ? 'sm:px-3' : 'sm:px-5'">
        <div class="h-px bg-black/[0.06]"></div>
    </div>

    {{-- ── Nav (scrollable) ────────────────────────────────────────────── --}}
    <nav class="tpc-neo-scroll flex-1 overflow-y-auto py-4 space-y-0.5 px-3" :class="sidebarCollapsed ? 'sm:px-2' : 'sm:px-3'">

        {{-- Section: Main --}}
        <p class="px-3 pb-2 text-[10px] font-semibold tracking-widest text-neo-ink/40 uppercase
        ...
        <a href="{{ route('admin.dashboard') }}" @click="closeMobileSidebar()" title="Dashboard"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $dashActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.programs.index') }}" @click="closeMobileSidebar()" title="Programs"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $progActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.news-posts.index') }}" @click="closeMobileSidebar()" title="News Posts"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $newsActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.news-review.index') }}" @click="closeMobileSidebar()" title="News Review"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $reviewActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.admission.index') }}" @click="closeMobileSidebar()" title="Admission"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $admActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.about-slides.index') }}" @click="closeMobileSidebar()" title="About Slides"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $slidesActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.services.index') }}" @click="closeMobileSidebar()" title="Services"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $servicesActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $orgActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.messages.index') }}" @click="closeMobileSidebar()" title="Messages"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $msgsActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $feedbackActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.users.index') }}" @click="closeMobileSidebar()" title="Users"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $usersActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
        ...
        <a href="{{ route('admin.settings.edit') }}" @click="closeMobileSidebar()" title="Settings"
           ...
           :class="sidebarCollapsed ? 'sm:px-2 sm:gap-0 sm:justify-center' : ''">
            <span class="absolute left-0 top-1/2 -translate-y-1/2 h-7 w-[3px] rounded-r-full bg-tpc-primary transition-opacity duration-200 {{ $setActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-30' }}"></span>
    ...
    {{-- ── Account (fixed footer, not part of the scrollable nav) ───────── --}}
    <div class="flex-shrink-0 px-3 pb-4 pt-3" :class="sidebarCollapsed ? 'sm:px-2' : 'sm:px-3'">
        <div class="h-px bg-black/[0.06] mb-3"></div>
