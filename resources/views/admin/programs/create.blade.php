...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
            <h1 class="text-lg font-semibold text-neo-ink">Create Program</h1>
            <p class="text-xs text-neo-ink/45 mt-0.5">Add a new academic program.</p>
        </div>
        ...
        <div class="grid gap-5 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="description" rows="4" placeholder="Brief description of the program..."
                          class="w-full rounded-xl bg-neo-bg shadow-neo-inset-sm border-0 px-3 py-2.5 text-sm text-neo-ink placeholder-neo-ink/30 focus:outline-none focus:ring-2 focus:ring-tpc-primary/30 transition resize-none">{{ old('description') }}</textarea>
