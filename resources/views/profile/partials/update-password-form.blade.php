...
<div class="px-5 py-4 border-b border-black/[0.06] flex items-center gap-3">
    ...
    <div>
        <h2 class="text-sm font-semibold text-neo-ink">{{ __('Update Password') }}</h2>
        <p class="text-xs text-neo-ink/40 mt-0.5">{{ __('Use a long, random password to stay secure.') }}</p>
    </div>
</div>
    ...
    <div>
        ...
        <div class="relative">
            <input id="update_password_current_password" name="current_password"
                   ...
                   class="w-full bg-neo-bg shadow-neo-inset-sm border-0 rounded-xl px-4 py-2.5 pr-11 text-sm text-neo-ink
